...
enum cmdloop_dmrcmds
{
    ...
    RCP_GETMEDIAINFO, RCP_GETPOSITION, RCP_GETTRANSINFO, RCP_GETVOLUME, RCP_GETMUTE, MRCP_EXIT, RCP_REFRESH,
...
static struct cmdloop_commands cmdloop_cmdlist[] = {
    ...
    {"DmrTrans", RCP_GETTRANSINFO, 2, "<devnum>"},
    ...
    {"DmrTransInfo", RCP_GETTRANSINFO, 2, "<devnum>"},
    {"DmrGetVol", RCP_GETVOLUME, 2, "<devnum>"},
    {"DmrGetMute", RCP_GETMUTE, 2, "<devnum>"},
    {"Exit", MRCP_EXIT, 1, ""},
    {"DmrRefresh", RCP_REFRESH, 1, ""},
    {"LsDms", MCP_PRINT, 1, ""},
...
int paraseCmd( char * cmdline )
{
    ...
    case RCP_GETTRANSINFO:
        GetTransportInfo( arg1 );
        break;
